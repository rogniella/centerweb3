            ...
            <div class="panel-body">
                <div class="form-group">
                  ...
                  <select id="filtro0" name="filtro0" class="form-control"> 
                      ...
                      <option value= '0001'>0001 - Página AFIP</option>
                      <option value= '0002'>0002 - PDF - WS AFIP</option>
                      <option value= '9999'>9999 - Con Error Pendientes</option>
                  </select>
                  <select id="filtro1" name="filtro1" class="form-control"> 
                      <option value= ''>[Todos Tipos]</option>
                      <option value= 'C'>Facturas C</option>
                      <option value= 'P'>Notas Crédito C</option>
                  </select>
