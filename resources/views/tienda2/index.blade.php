        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section_title text-center">Center FotoOptica</div>
                </div>
            </div>
                    ...
                    <div class="product">
                        ...
                        <div class="product_content">
                            <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                <div>
                                    <div>
                                        <div class="product_name"><a href="product.html">{{ $item->titulo }}</a></div>
                                        
                                    </div>
                                </div>
                                <div class="ml-auto text-right">
                                    <div class="product_category">En <a href="category.html">Stock</a></div>
                                    <div class="product_price text-right">$ {{$item->precio }} </div>
                                </div>
                            </div>
                            <div class="product_buttons">
                                <div class="text-right d-flex flex-row align-items-start justify-content-start">										
            ...
            <div class="row load_more_row">
                <div class="col">
                    <div class="button load_more ml-auto mr-auto"><a href="#">buscar más</a></div>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="product">
                                    <div class="product_image">
                                       @if ($item->images->count()<=0 )
                                         <img src="{{ asset('/imagenes/avatar.jpg')}}" 
                                       @else
                                    ...
                                    <div class="product_content">
                                        <div class="product_info d-flex flex-row align-items-start justify-content-start">
                                            ...
                                            <div class="ml-auto text-right">
                                                ...
                                                <div class="product_price text-right">{{ $item->precio_anterior }}</div>
                                            </div>
                                        </div>
                                        <div class="product_buttons">
                                            <div class="text-right d-flex flex-row align-items-start justify-content-start">										
