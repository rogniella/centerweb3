...
@section('titulo','Pedidos InterSucursales')
...
<div class="panel panel-info">         
    ...
    <div class="row" >
        <div class="col-lg-2 col-md-2" id="titulo_pagina"><b> PEDIDOS INTER-SUCURSALES </b> </div>
      </div>   
    </div>   <!-- /Fin Header Panel  -->

    <div class="panel-body">         
        <input type="hidden" name="idcompra" id="idcompra" value="-1">
        <div class="row" >
...
<script>
  ...
  $(function () {
    ...
    $("#jsTabla").jsGrid({
       ...
       // inserting: true,  // Para Insertar
        ...
        deleteConfirm: "Confirma el Borrado del Artículo ?",
        autoload: true,
        controller: {
            loadData: function() {
                var d = $.Deferred();
  ...
  //              return d.promise();
        ...
        fields: [
            { type: "control", width: 53 , visible: true ,
            ...
            { title: "Sucursal", name: "MLot_Sucursal", type: "number",width: 57 ,editing: false},
            { title: "Cant.Solicitada", name: "MLot_Cantidad", type: "number",width: 57  },
            { title: "Familia", name: "MLot_Familia", type: "text",editing: false  ,width: 59 , align: "center"},
            { title: "Código", name: "MLot_IdProd", type: "text", width: 80 , validate: "required" , editing: false,  align: "center"},
            { title: "Categoría", name: "Prod_Categoria", type: "text", width: 75 ,editing: false },
            { title: "Descripción", name: "Prod_Descripcion", type: "text", width: 130 ,editing: false },
            { title: "Observación", name: "MLot_Descripcion", type: "text", width: 150 },
            { title: "Cant.Enviada", name: "MLot_CantEnv", type: "number",  editing: false , width: 50, itemTemplate: function(value)  {return formatoPesos(value);}  },
            { title: "Remito", name: "MLot_Remito", type: "text" , width: 50 ,   editing: false, itemTemplate: function(value)  {return formatoRemito(value);} },
        ]
    });
  });


      function formatoRemito( value) {
        ...
        if (value != 0) {
            ...
            return '<a onclick="showAltaItem()">Ingresar</a>';
        }
