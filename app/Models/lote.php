...
class lote extends Model
{
    ...
    public static function buscarCtrolStock($lot_estado, $tipo_lote, $numlot, $sucursal)
    {
        ...
        if ($tipo_lote == 'T') {
            ...
            $consulta .= ' where lot_operacion= \'T\' and lot_estado = ?'.$filtro.' ORDER BY Lot_fecmov desc';
        } else {
            ...
            $consulta .= ' where lot_operacion= \'S\' and Lot_IdProv = ? ORDER BY Lot_fecmov desc';
            $valores = [$numlot];
        }
    ...
    public static function buscarPendientes($lot_estado)
    {
        ...
        $consulta .= ' where lot_operacion= \'C\' and lot_estado = ? ORDER BY Lot_fecmov desc';

        $datos = DB::select($consulta, [$lot_estado]);
    ...
    public static function buscarRemitos($lot_estado)
    {
        ...
        $consulta .= ' where lot_operacion= \'W\' and lot_estado = ? ORDER BY Lot_fecmov desc';
