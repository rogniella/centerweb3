...
namespace App\clases\PDFFactura;
...
class PDFVoucher extends Html2Pdf
{
    ...
    public function __construct($voucher, $config)
    {
     ...
     * @author NeoComplexx Group S.A.
     */
    public function addVoucherInformation($logo_path, $title)
    {
     ...
     * @author: NeoComplexx Group S.A.
     */
    public function addReceiverInformation()
    {
        ...
        if ($this->show_element('footer')) {
            ...
            if ($this->voucher['cae'] != 0) {
                ...
                */
                ...
                $datosQR = ['ver' => '1', 'fecha' => $fechaComp, 'cuit' => $cuit, 'ptoVta' => $this->voucher['numeroPuntoVenta'], 'tipoCmp' => $this->voucher['codigoTipoComprobante'], 'nroCmp' => $this->voucher['numeroComprobante'], 'importe' => number_format((float) round($this->voucher['importeTotal'], 2), 2, '.', ''), 'moneda' => 'PES', 'ctz' => '1', 'tipoDocRec' => $this->voucher['codigoTipoDocumento'], 'nroDocRec' => $this->voucher['numeroDocumento'], 'tipoCodAut' => 'E', 'codAut' => $cae,
                ];
     ...
     * @author NeoComplexx Group S.A.
     */
    public function emitirPDF($logo_path, $solo_original = false)
    {
        // ORIGINAL
        $this->html .= '<page>';
