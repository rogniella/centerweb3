    ...
    public static function valida_estado_servidor()
    {
        ...
        */
        ...
        try {
            ...
            if ($informacion->appserver != 'OK') {
                $msgError = 'Error en Servidor Afip (appserver)';
            }
            if ($informacion->authserver != 'OK') {
                $msgError = 'Error de Autorización Servidor Afip (authserver)';
            }
            if ($informacion->dbserver != 'OK') {
                $msgError = 'Error de Base en Servidor Afip (dbserver)';
            }
