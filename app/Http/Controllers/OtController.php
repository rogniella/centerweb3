...
use App\Models\sucursal;  // Modelos a utilizar
        ...
        switch ($ot->Ot_Tipo) {
            case $ot->Ot_Tipo == 'A' || $ot->Ot_Tipo == 'G':  // Anteojos Recetados
                ...
                if ($ot->DatosREC->OtAnt_LejMaterial != '') {
                    ...
                    $datos[] = ['titulo' => '', 'valor' => lineaDescriGrado('OD', $ot->DatosREC->OtAnt_LejODEsf, $ot->DatosREC->OtAnt_LejODCil, $ot->DatosREC->OtAnt_LejODGrad).'<br>'.
